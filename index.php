...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="containar-fluer">
            <div class="navbar-header">
                <a href="demo.html" class="navbar-brand">LAMP Sample</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <ul class="nav nav-tabs">
         ...
         <li class="nav-items"><a href="#tab3" class ="nav-link" data-toggle="tab">update</a></li>
         <li class="nav-items"><a href="#tab4" class ="nav-link" data-toggle="tab">delete</a></li>
        </ul>
